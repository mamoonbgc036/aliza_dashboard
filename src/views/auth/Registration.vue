		...
		<div class="col-md-8 ps-md-0">
			<div class="auth-form-wrapper px-4 py-5">
				...
				<form @submit.prevent="createUser" class="forms-sample">
					<div class="mb-3">
						<label for="exampleInputUsername1" class="form-label text-info"
							>Name</label
						>
						<input
							type="text"
							...
							name="name"
						/>
						<p v-if="errors.name != undefined" class="text-danger">
							{{ errors.name[0] }}
						</p>
					</div>
					<div class="mb-3">
						...
						<input
							...
							name="phone"
						/>
						<p v-if="errors.phone != undefined" class="text-danger">
							{{ errors.phone[0] }}
						</p>
					</div>
					<div class="mb-3" data-select2-id="7">
						...
						<p v-if="errors.type != undefined" class="text-danger">
							{{ errors.type[0] }}
						</p>
					</div>
					<div class="mb-3">
						<label class="form-label text-info" for="formFile"
							>Image Upload</label
						>
						<input
							class="form-control"
							...
							id="formFile"
						/>
						<p v-if="errors.image != undefined" class="text-danger">
							{{ errors.image[0] }}
						</p>
					</div>
					<div class="mb-3">
						...
						<input
							...
							name="password"
						/>
						<p v-if="errors.password != undefined" class="text-danger">
							{{ errors.password[0] }}
						</p>
					</div>
				...
				<router-link to="/" class="d-block mt-3 text-info"
